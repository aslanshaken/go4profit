...
function Home() {
  ...
  const testimonials = [
    ...
    // },
    {
      ...
      name: 'Nikita Glazkov',
      role: 'CEO, Example Co.',
      text: 'This is exactly what you need if you are in the trucking business. They will help you break down your income and expenses clearly, and guide your company to the next level. I highly recommend them!',
    },
    {
      id: 2,
      // imageUrl: Whizz,
    ...
    },
    {
      ...
      text: 'I was impressed with how easy they made bookkeeping for us. Their team was always there to help with everything—from sorting daily payments to getting ready for tax season. They’re truly care.',
    },
    {
      id: 4,
      // imageUrl: Ferla,
      name: 'Bauer Altynbek',
      role: 'Developer, Tech Solutions',
      text: 'We recently worked with Go4Profit and Ainur for our company bookkeeping needs, and I couldn’t be more impressed. From start to finish, their professionalism and efficiency were outstanding.',
    },
    {
      id: 5,
      // imageUrl: Ferla,
      ...
      role: 'Developer, Tech Solutions',
      text: 'I just want to say thank you Ainura and your company for your hard work with our company. You help me a lot to understand my money in and money out. Now i have everything organize and clear.',
    },
    {
      id: 6,
      // imageUrl: Ferla,
      name: 'Lee Young',
      role: 'Developer, Tech Solutions',
      text: 'They always keep my books accurate and on time I couldn’t ask for better. Super easy to work with and take care of everything so I don’t have to stress. Everything’s been smooth and professional.',
    },
  ];
  ...
  return (
    <div>
      ...
      <main className="home-container" aria-label="Home Page">
        ...
        <section>
          ...
          <div id="call" className="flex-center">
            ...
            <div className="calendly-inline-widget" data-url="https://calendly.com/synoro-ai/30min" style={{ minWidth: '320px', height: '700px' }}></div>
          </div>
        ...
        <footer className="home-footer">
          <div className="footer-content">
            ...
            <ul>
              ...
              {/* <li><b>Phone Number:</b> +1(917) 200-7609</li> */}
              <li>6250 Riverside St. Blvd, Secaucus, NJ 07094</li>
            </ul>
          </div>
          <p>Copyright © 2025 Go4Profit | All rights reserved</p>
        </footer>
      </main>
    </div>
  )
